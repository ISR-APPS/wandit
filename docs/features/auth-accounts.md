...
- Drafts with attachments or a source still, video drafts, and drafts older than the 15-minute autostart TTL restore as prefill only; the user completes them and clicks Generate.
