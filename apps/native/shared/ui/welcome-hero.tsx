...
export function FitCalWelcomeHero({
  ...
  return (
    <Card
      ...
      {...props}
    >
      <View className="absolute right-6 top-6 h-12 w-12 items-center justify-center rounded-full bg-foreground">
        <Ionicons name="flash" size={23} color={accent} />
      </View>

      <View className="absolute left-6 top-6 gap-1">
      ...
      <View className="rounded-[16px] bg-foreground px-4 py-[14px]">
        <AppText
          ...
          className="text-[12px] font-bold uppercase leading-4 text-accent"
        >
          Today · Day 12
        </AppText>
        <AppText
          allowFontScaling={false}
          className="mt-0.5 text-[20px] font-extrabold leading-[25px] text-background"
        >
