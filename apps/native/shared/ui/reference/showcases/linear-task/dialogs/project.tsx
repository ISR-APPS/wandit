    ...
    () => [
      {
        ...
        label: "No Project",
        indicator: (
          <StyledMaterialCommunityIcons name="cube-outline" size={14} className="text-muted" />
        ),
      },
      {
      ...
      },
      {
        ...
        label: "HeroUI Chat",
        indicator: (
          <StyledMaterialCommunityIcons name="adjust" size={14} className="text-success" />
        ),
      },
    ],
    [],
              ...
              >
                <RadioGroup value={value} onValueChange={setValue} className="gap-7">
                  {filteredItems.map((item) => (
                    <ProjectRadioItem key={item.value} item={item} value={value} />
                  ))}
                </RadioGroup>
              </StyledScrollView>
            )}
