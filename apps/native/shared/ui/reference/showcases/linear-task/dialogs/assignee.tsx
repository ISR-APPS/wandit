			...
			},
			{
				...
				indicator: (
					<Avatar alt="junior" className="size-[18px] bg-sky-500">
						...
						/>
						<Avatar.Fallback>
							<AppText className="font-bold text-[8px] text-white">JG</AppText>
						</Avatar.Fallback>
					</Avatar>
				),
			},
			{
				...
				indicator: (
					<Avatar alt="volo" className="size-[18px] bg-purple-500">
						...
						/>
						<Avatar.Fallback>
							<AppText className="font-bold text-[8px] text-white">VS</AppText>
						</Avatar.Fallback>
					</Avatar>
				),
			},
					...
					>
						...
						{filteredItems.length === 0 && (
							<View className="flex-1 items-center justify-center">
								<AppText className="font-medium text-base text-muted">
									No results
								</AppText>
							</View>
						)}
