		...
		return (
			<View className="items-center gap-6">
				<Avatar size="lg" color="accent" variant="soft" alt="Verification icon">
					<Avatar.Fallback>
						<AppText className="font-semibold text-2xl">✓</AppText>
					</Avatar.Fallback>
				</Avatar>
				...
				<View className="items-center gap-1 px-2">
					...
					<AppText className="mt-1 text-center font-semibold text-base">
			...
			>
				...
				<View className="mt-8 gap-3">
					...
					<View className="mt-2 flex-row items-center justify-center">
						<AppText className="text-center text-muted text-sm">
				...
				<View className="mt-8 px-2">
					<AppText className="text-center text-muted text-xs leading-5">
