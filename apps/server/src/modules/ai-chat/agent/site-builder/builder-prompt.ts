...
- User asset URLs listed in the brief (product photos, logos) are allowed and may be placed directly. URLs returned by generate_image and animate_image are allowed, and so are previously generated Wandit asset URLs listed in the brief (a MEDIA ASSETS / BRAND ASSETS line naming a ready image or video URL and its intended placement). Never use any other external image or video URL.
