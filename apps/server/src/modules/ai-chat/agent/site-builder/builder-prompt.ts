...
- Pass 3 — final verification: confirm every pass-1 and pass-2 fix actually landed in the screenshots · zero errors, zero overflow · then 1-2 finishing touches that push the page further (a texture layer, a caption, an overlap, a better seam) if and only if they carry no risk.
