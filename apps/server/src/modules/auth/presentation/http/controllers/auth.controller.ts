...
export class AuthController {
  ...
  @All()
  async handleAuthRoot(@Req() request: FastifyRequest, @Res() reply: FastifyReply) {
    await this.handleAuthRequest(request, reply);
  }

  @All("*")
  async handleAuthPath(@Req() request: FastifyRequest, @Res() reply: FastifyReply) {
    await this.handleAuthRequest(request, reply);
  }

  private async handleAuthRequest(request: FastifyRequest, reply: FastifyReply) {
    try {
