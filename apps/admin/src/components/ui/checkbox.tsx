	...
	return (
		...
		>
			<CheckboxPrimitive.Indicator
				...
				className="grid place-content-center text-current transition-none [&[data-state=checked]>svg:last-child]:hidden [&[data-state=indeterminate]>svg:first-child]:hidden"
			>
