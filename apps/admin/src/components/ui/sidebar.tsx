...
const SIDEBAR_COOKIE_NAME = "wandit_admin_sidebar_state";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: the dashboard shell mirrors shadcn's cookie-based sidebar persistence.
