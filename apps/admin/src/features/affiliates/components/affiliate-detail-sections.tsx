...
export function AffiliateMetrics({ detail }: { detail: AffiliateDetail }) {
	const metrics = [
		...
		},
		{
			...
			tooltip:
				"Attributed free users at least seven days old who consumed at least 3 credits and completed at least two successful generations in their first seven days.",
		},
		{
			label: "Churned",
