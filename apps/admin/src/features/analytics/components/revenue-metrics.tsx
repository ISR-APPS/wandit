		...
		<AnalyticsMetricStrip
			...
			metrics={[
				...
				},
				{
					...
					tooltip:
						"Free users who really used the product: 20+ credits and 2+ generations in their first 7 days. The supporting percentages show healthy trials as a share of all trials, then healthy versus other trial-to-paid rates.",
