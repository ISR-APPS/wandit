					...
					<CardTitle>
						<h2 className="flex items-center gap-1">
							...
							<MetricInfoTooltip
								...
								content="Free users who used at least 7 credits and completed at least two generations in their first seven days. Each user is assigned to signup day plus seven."
							/>
						</h2>
					</CardTitle>
					<CardDescription className="mt-1">
