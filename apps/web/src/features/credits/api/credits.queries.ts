...
// the ACTIVE workspace's pool, so the key carries the workspace segment. The
// all-workspaces balances list is deliberately UN-scoped (same answer in every
// workspace) but stays under the "credits" prefix so billing-error
