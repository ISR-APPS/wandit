...
CREATE UNIQUE INDEX "payment_orders_providerRefundId_uq" ON "payment_orders" USING btree ("provider_refund_id");--> statement-breakpoint
...
CREATE INDEX "credit_ledger_paymentIntentId_idx" ON "credit_ledger" USING btree (("meta" ->> 'paymentIntentId'));--> statement-breakpoint
CREATE INDEX "credit_ledger_chargeId_idx" ON "credit_ledger" USING btree (("meta" ->> 'chargeId'));