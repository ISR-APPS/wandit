...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: role="group" on a div is the stock shadcn pattern
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: role="group" on a div is the stock shadcn pattern
		// biome-ignore lint/a11y/useKeyWithClickEvents: click only forwards focus to the inner input; keyboard users tab directly
		<div
			role="group"
