---
name: "monographe"
description: "A dark architectural monograph: hairline serif type on near-black paper, plate captions and folio numbers, one bronze word glowing in each headline — the page of a house that introduces rather than advertises."
---

# DESIGN WORLD: MONOGRAPHE — the architectural monograph
