---
name: "matiere"
description: "A sun-warmed wall of materials: arches as the only geometry, rooms painted as CSS/SVG miniatures with light glowing inside them, a chunky serif that never whispers, and a cabinet of drawn material samples that re-tints the whole page when touched — the warmth of a real atelier, zero photography."
---

# DESIGN WORLD: MATIÈRE — the sunlit material atelier
