---
name: "ads-creative"
description: "Hook rate, hold rate, retention, CTR outbound vs all, fatigue signals, creative velocity, modular testing (hook / body / proof / CTA), first-3-seconds engineering, angle sources, format win conditions, what to brief to Wandit's generators. Load for any creative, ad copy, or video-ad question."
---
